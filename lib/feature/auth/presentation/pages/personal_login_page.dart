...
class PersonalLoginPage extends HookConsumerWidget {
      ...
      return Column(
        children: [
          ...
          Container(
            ...
            child: const Icon(Icons.person_rounded, size: 40, color: primaryColor),
          ),
    ...
    return CustomizeScaffold(
      body: Stack(
        children: [
                    ...
                    child: IconButton(
                      ...
                      style:
                          IconButton.styleFrom(
                            ...
                            shadowColor: Colors
                                .transparent, // manual shadow if needed, but keeping simple
                          ).copyWith(
                            backgroundColor: WidgetStateProperty.all(Colors.white),
                            // Add shadow via decoration wrapper if strictly needed, or trust material elevation if visible
                            // For clean look, just simple white button
                          ),
                    ),
                  ),
                ),
          ...
          if (isLoading.value)
            Container(
              color: Colors.black.withValues(alpha: 0.2), // Light dim
              child: Center(
                child: Container(
